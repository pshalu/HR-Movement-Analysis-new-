...
americas = read_excel("C:/Users/HP/Downloads/HR Dashboard_v1 - Americas.xlsx")

apac = read_excel("C:\\Users\\HP\\Downloads\\HR Dashboard_v1 - APAC.xlsx")

europe = read_excel("C:\\Users\\HP\\Downloads\\HR Dashboard_v1 - Europe.xlsx")
#Consolidating global data
global = rbind(americas,apac,europe)

#Read file containing country coordinates
country_coor = read_excel("C:\\Users\\HP\\Downloads\\country coord.xlsx")
...
p1=plot_ly(data = h1,
  ...
  layout(xaxis=list(title="Month"),
         ...
         plot_bgcolor = "#D8BFD8", # set the background color of the plot
         paper_bgcolor = "pink") # set the background color of the paper
...
p2=plot_geo(h2,locationmode="world") %>% 
  ...
  layout(plot_bgcolor = "black", # set the background color of the plot
         paper_bgcolor = "pink") # set the background color of the paper
...
p3=plot_ly(h3,
  ...
  p3 <- p3 %>% 
  layout(plot_bgcolor = "white",  # set the background color of the plot
         paper_bgcolor = "black")  # set the background color of the paper
...
p7=plot_ly(h7) %>% 
 ...
 p7 <- p7 %>% layout(plot_bgcolor = "black",# set the background color of the plot
         paper_bgcolor = "black")  # set the background color of the paper
...
p8=plot_ly(h8) %>% 
 ...
 p8 <- p8 %>% layout(plot_bgcolor = "black",# set the background color of the plot
         paper_bgcolor = "black")  # set the background color of the paper
...
p10=plot_ly(data = h10,
  ...
  p10 <- p10 %>% 
  layout(plot_bgcolor = "white",  # set the background color of the plot
         paper_bgcolor = "yellow")  # set the background color of the paper
