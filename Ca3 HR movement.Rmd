...
americas = read_excel(file.choose())

apac = read_excel(file.choose())

europe = read_excel(file.choose())
#Consolidating global data
global = rbind(americas,apac,europe)

#Read file containing country coordinates
country_coor = read_excel(file.choose())
...
p7=plot_ly(h7) %>% 
 ...
 p7 <- p7 %>% layout(plot_bgcolor = "white",# set the background color of the plot
         paper_bgcolor = "white")  # set the background color of the paper
...
p8=plot_ly(h8) %>% 
 ...
 p8 <- p8 %>% layout(plot_bgcolor = "white",# set the background color of the plot
         paper_bgcolor = "white")  # set the background color of the paper
